...
Or download [OpenBar v0.1.1](https://github.com/4nkitd/openbar/releases/download/v0.1.1/OpenBar-0.1.1-macos-arm64.zip), unzip it, and move **OpenBar.app** into **Applications**.
